#ifndef LUWU_WS_SERVLET_H
#define LUWU_WS_SERVLET_H
...
namespace liucxi {
    namespace http {
        ...
        public:
            ...
            typedef std::function< int32_t(HttpRequest::ptr header, WSSession::ptr session)
            ...
            typedef std::function< int32_t(HttpRequest::ptr header, WSFrameMessage::ptr msg,
            ...
            virtual int32_t
            onConnect(HttpRequest::ptr header, WSSession::ptr session) override;
